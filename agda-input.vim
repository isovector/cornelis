...
if !exists("g:cornelis_no_agda_input")
  ...
  call cornelis#bind_input("Glb", "⨅")
  call cornelis#bind_input("Lub", "⨆")
  call cornelis#bind_input("<bar>-", "⊢")
  call cornelis#bind_input("<bar>-n", "⊬")
  call cornelis#bind_input("-<bar>", "⊣")
  call cornelis#bind_input("<bar>=", "⊨")
  call cornelis#bind_input("<bar>=n", "⊭")
  call cornelis#bind_input("<bar><bar>-", "⊩")
  call cornelis#bind_input("<bar><bar>-n", "⊮")
  call cornelis#bind_input("<bar><bar>=", "⊫")
  call cornelis#bind_input("<bar><bar>=n", "⊯")
  call cornelis#bind_input("<bar><bar><bar>-", "⊪")
  call cornelis#bind_input("<bar>", "∣")
  call cornelis#bind_input("<bar>n", "∤")
  call cornelis#bind_input("<bar><bar>", "∥")
  call cornelis#bind_input("<bar><bar>n", "∦")
  ...
  call cornelis#bind_input("lr=n", "⇎")
  call cornelis#bind_input("<=>n", "⇎")
  call cornelis#bind_input("l-<bar>", "↤")
  call cornelis#bind_input("ll-", "↞")
  call cornelis#bind_input("r-<bar>", "↦")
  call cornelis#bind_input("rr-", "↠")
  call cornelis#bind_input("u-<bar>", "↥")
  call cornelis#bind_input("uu-", "↟")
  call cornelis#bind_input("d-<bar>", "↧")
  call cornelis#bind_input("dd-", "↡")
  call cornelis#bind_input("ud-<bar>", "↨")
  call cornelis#bind_input("l->", "↢")
  call cornelis#bind_input("r->", "↣")
